...
const Spreadsheet: React.FC<SpreadsheetProps> = ({
  ...
  return (
    ...
    >
      <div className="w-full overflow-hidden rounded-xl border border-gray-200/80 shadow-sm">
        <table
          ref={tableRef}
          ...
          <thead>
            <tr className="bg-gray-50">
              ...
              {data.headers.map((header, index) => (
                <th
                  key={index}
                  className={`w-40 max-w-[150px] bg-transparent border-b border-gray-300 p-3 text-gray-600 font-semibold text-left relative h-12 ${
                  ...
                  <div className="flex justify-between items-center group">
                    ...
                    <div className="flex space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button
                        ...
                        title={`Deep Research: ${deepResearch ? 'ON' : 'OFF'}`}
                      >
                        <Info size={14} />
                      </button>
                      <button
                        ...
                        title={`Enrich column using ${deepResearch ? 'Deep Research (Kimi K2)' : 'Standard Search'}`}
                      >
                        <Sparkles size={14} />
                      </button>
                    </div>
              ...
              {data.headers.length < 5 && (
                <th
                  className={`w-14 bg-transparent border-b border-gray-300 text-center ${
