...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-600 to-blue-400 p-8 relative overflow-hidden">
      <div className="absolute top-8 left-5 flex items-center space-x-2 bg-white/80 px-4 py-2 rounded-lg shadow-md backdrop-blur-lg z-50">
        <img src="../brightdataicon.svg" alt="WatsonX Logo" className="h-6" />
